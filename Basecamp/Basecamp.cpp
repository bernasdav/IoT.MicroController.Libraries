...
bool Basecamp::begin()
{
	...
	web.addInterfaceElement("resetform", "input", " ", "#configform");
	web.setInterfaceElementAttribute("resetform", "type", "button");
	web.setInterfaceElementAttribute("resetform", "value", "Reset");
	web.setInterfaceElementAttribute("resetform", "onclick", "resetConfiguration()");
...
const char *Basecamp::macId()
{
	String m = this->_generateMac();
	const char *id;
	id = m.c_str();
	return id;
}

void Basecamp::mqttConnect()
{
#ifndef BASECAMP_NOMQTT
